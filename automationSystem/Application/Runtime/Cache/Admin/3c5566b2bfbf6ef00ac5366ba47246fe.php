...
<head>
	...
	<link rel="stylesheet" href="/automationSystem/Public/Admin/css/login.css" />
			...
			<div class="login1">
                ...
                <div class="login-input">
                    ...
                    <p class="yzm ue-clear">
                        ...
                        -->
                        <cite><img style="margin-left: 3px;" src="/automationSystem/Admin/Public/captcha" onclick="this.src='/automationSystem/Admin/Public/captcha/t/'+Math.random()" /></cite>
                    </p>
                </div>
