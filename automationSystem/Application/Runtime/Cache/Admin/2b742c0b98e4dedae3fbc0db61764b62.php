...
<link rel="stylesheet" href="/automationSystem/Public/Admin/css/home.css" />
...
<div class="article toolbar">
    ...
    <div class="content">
    	<ul class="toollist ue-clear">
    		<li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon01.png" /></a>
                <p><a href="javascript:;">通知公告</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon02.png" /></a>
                <p><a href="javascript:;">知识库</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon03.png" /></a>
                <p><a href="javascript:;" date-src="<?php echo U('User/exit');?>" id="1">密码修改</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon04.png" /></a>
                <p><a href="javascript:;">日程安排</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon05.png" /></a>
                <p><a href="javascript:;">添加文章</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon06.png" /></a>
                <p><a href="javascript:;">网络硬盘</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon07.png" /></a>
                <p><a href="javascript:;">参数信息</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon08.png" /></a>
                <p><a href="javascript:;">回收站</a></p>
            </li>
            <li>
            	<a href="javascript:;" class="img"><img src="/automationSystem/Public/Admin/images/icon09.png" /></a>
                <p><a href="javascript:;">系统配置</a></p>
            </li>
            <li class="add-btn">
            	<img src="/automationSystem/Public/Admin/images/add.png" />
            </li>
    	</ul>
	...
	<div class="wrap-l">
        ...
        <div class="content">
        	<ul class="notice-list">
                ...
                <li class="ue-clear">
                	<a href="javascript:;" class="notice-title">2019年全市通信行业安全生产工作要点</a>
                    <div class="notice-time">05-08</div>
                </li>
                <li class="ue-clear">
	...
	<div class="wrap-r">
        ...
        <div class="content">
        	<div class="matter-content current ue-clear">
            	<div class="today">
                	<p class="year"><script type="text/javascript">
   var d = new Date();  
  ...
  document.write(d.getDate());  
                ...
                <ul class="matter-list">
                	<li class="ue-clear">
                        ...
                        <a href="javascript:;" class="matter-title">下午2点中国移动召开2019年工作会议</a>
                    </li>
                    <li class="ue-clear">
                    	<span class="matter-time">05-08</span>
                    ...
                    <li class="ue-clear">
                    	<span class="matter-time">05-08</span>
                        <a href="javascript:;" class="matter-title">南京2019年全国移动技术投标大会报名事宜</a>
                    </li>
                    <li class="ue-clear">
                    	<span class="matter-time">05-08</span>
        	...
        	<table>
                ...
                <tbody>
                	<tr>
                        ...
                        <td class="leader">QinHsiu</td>
                        <td class="contact">139039409876</td>
                        <td class="remark">管理部门</td>
                    </tr>
                    <tr>
                    	<td class="date">08-09</td>
                        <td class="week">星期二</td>
                        <td class="leader">zb</td>
                        <td class="contact">139039423423</td>
                        <td class="remark">销售部</td>
                    </tr>
                    <tr>
                    	<td class="date">08-10</td>
                        <td class="week">星期三</td>
                        <td class="leader">admin</td>
                        <td class="contact">149039409876</td>
                        <td class="remark">管理部</td>
                    </tr>
                    <tr>
                    	<td class="date">08-11</td>
                        <td class="week">星期四</td>
                        <td class="leader">qw</td>
                        <td class="contact">123039409876</td>
                        <td class="remark">财务部</td>
                    </tr>
                    <tr>
                    	<td class="date">08-12</td>
                        <td class="week">星期五</td>
                        <td class="leader">qt</td>
                        <td class="contact">132339409876</td>
                        <td class="remark">人力资源部门</td>
                    </tr>
                </tbody>
            </table>
        </div>
