	...
	<table>
        ...
        <tbody>
            <?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vol): $mod = ($i % 2 );++$i;?><tr>
                ...
                <a href="/automationSystem/Admin/Dept/edit/id/<?php echo ($vol["id"]); ?>">编辑</a>
                </td>
...
<div class="pagination ue-clear">
    ...
    <div class="pxofy">显示第 1 条到 10 条记录，共 <?php echo ($count); ?> 条记录</div>
</div>
</body>
...
$(function(){
	...
	$('.del').on('click',function(){
		...
		//带着参数跳转到del方法
		window.location.href = '/automationSystem/Admin/Dept/del/id/' + id;
	});
});
</script>
</html>